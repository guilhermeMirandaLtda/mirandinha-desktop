...
NODE_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "flow.foreach": {
        ...
        "needs_on_error": False,
        "implemented": True,
        "description": "Define a unidade de progresso e de skip_item. Etapa 4: a porta 'done' precisa apontar direto para um flow.end — nós depois do laço chegam em etapa futura.",
    },
    "flow.if": {
        "label": "Se",
        "category": "Lógica & dados",
        ...
        "needs_on_error": False,
        "implemented": True,
        "description": "Três campos estruturados. Nunca uma expressão avaliada. Operadores: ==, !=, >, >=, <, <=, contains, empty, not_empty.",
    },
    "data.excel_read": {
        "label": "Ler planilha",
        "category": "Dados",
        ...
        "default_on_error": "abort",
        "implemented": True,
        "description": "Reaproveita o pandas que já está no projeto. Cada coluna aceita um 'as' (apelido sem espaço) para virar chave de {{linha.apelido}}; cada linha ganha '_row'.",
    },
    "data.distinct": {
    ...
    "data.first_match": {
        ...
        "needs_on_error": True,
        "implemented": True,
        "description": "Primeira linha de 'source' cujo campo bate com 'value' — o \"df[df.Diagrama==x].iloc[0]\" do robô nativo, como bloco.",
    },
    "data.format_date": {
